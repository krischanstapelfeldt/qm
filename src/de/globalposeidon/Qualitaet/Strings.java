...
public final class Strings {
	...
	public static final String METERREADINGVALUE = METER + " " + READING + " "
			+ VALUE;
	public static final String METERSEARCH = METER + " search";
	public static final String OPENJENKINS = OPENWSPACE + "Jenkins";
	public static final String OPENJUNITJENKINS = OPENWSPACE
			+ "JUnit report on Jenkins";
	public static final String OPENJACOCOJENKINS = OPENWSPACE
			+ "JaCoCo report on Jenkins";
