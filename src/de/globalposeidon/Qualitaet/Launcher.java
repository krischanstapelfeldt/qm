...
public class Launcher {
   ...
   public static DataContainer createRandomModel() {
      ...
      final Calendar cal = Calendar.getInstance(); // needed to set meters
      ...
      cal.set(2014, 10, 1);
      me.setCurrentValue(100);
      me.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.READING);
      cal.set(2014, 11, 1);
      me.setCurrentValue(9001);
      me.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      cal.set(2015, 0, 1);
      me.setYearValue(12501);
      me.setCurrentValue(12501);
      me.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      e.addMeter(me);
      final Meter meb = new Meter(dc.incMeterCnt(), Metertype.GAS, e);
      cal.set(2014, 10, 2);
      meb.setCurrentValue(10);
      meb.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.READING);
      cal.set(2014, 10, 6);
      meb.setCurrentValue(14);
      meb.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      e.addMeter(meb);
      // APARTMENT 1
      ...
      cal.set(2014, 10, 2);
      ma.setCurrentValue(99);
      ma.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      cal.set(2014, 11, 6);
      ma.setCurrentValue(300);
      ma.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.ESTIMATION);
      a.addMeter(ma);
      final Meter mab = new Meter(dc.incMeterCnt(), Metertype.GAS, a);
      cal.set(2014, 10, 2);
      mab.setCurrentValue(101);
      mab.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.READING);
      cal.set(2014, 11, 6);
      mab.setCurrentValue(4242);
      mab.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.ESTIMATION);
      a.addMeter(mab);
      final Meter mac = new Meter(dc.incMeterCnt(), Metertype.WATER, a);
      cal.set(2014, 10, 1);
      mac.setCurrentValue(100);
      mac.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.READING);
      cal.set(2014, 11, 1);
      mac.setCurrentValue(3345);
      mac.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      cal.set(2015, 0, 1);
      mac.setYearValue(6000);
      mac.setCurrentValue(6000);
      mac.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      a.addMeter(mac);
      // APARTMENT 2
      ...
      cal.set(2014, 10, 1);
      mbc.setCurrentValue(100);
      mbc.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.READING);
      cal.set(2014, 10, 17);
      mbc.setCurrentValue(400);
      mbc.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.READING);
      cal.set(2015, 0, 1);
      mbc.setYearValue(980);
      mbc.setCurrentValue(980);
      mbc.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      ab.addMeter(mbc);
      ...
      cal.set(2014, 10, 1);
      mcc.setCurrentValue(100);
      mcc.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.READING);
      cal.set(2014, 11, 20);
      mcc.setCurrentValue(3345);
      mcc.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      cal.set(2015, 0, 1);
      mcc.setYearValue(6000);
      mcc.setCurrentValue(6000);
      mcc.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      cal.set(2015, 1, 6);
      mcc.setCurrentValue(8101);
      mcc.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      ac.addMeter(mcc);
      ...
      cal.set(2014, 10, 1);
      mb2.setCurrentValue(4009);
      mb2.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.READING);
      cal.set(2014, 11, 20);
      mb2.setCurrentValue(9001);
      mb2.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      cal.set(2015, 0, 1);
      mb2.setYearValue(11000);
      mb2.setCurrentValue(11000);
      mcc.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      cal.set(2015, 1, 6);
      mb2.setCurrentValue(12010);
      mb2.makeReading(cal.getTime(), MeterReader.JANITOR, ReadingInfo.ESTIMATION);
      ab2.addMeter(mb2);
      ...
      cal.set(2014, 10, 1);
      mcc2.setCurrentValue(42);
      mcc2.makeReading(cal.getTime(), MeterReader.ENERGYPROVIDER, ReadingInfo.READING);
      cal.set(2014, 11, 20);
      mcc2.setCurrentValue(9001);
      mcc2.makeReading(cal.getTime(), MeterReader.RENTER, ReadingInfo.ESTIMATION);
      ac2.addMeter(mcc2);
