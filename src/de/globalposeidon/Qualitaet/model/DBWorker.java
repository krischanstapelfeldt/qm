...
public class DBWorker {
   ...
   private void createStructures() throws SQLException {
      ...
      statement.executeUpdate("CREATE TABLE IF NOT EXISTS `Building` " + "(`id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,"
      ...
      statement.executeUpdate("CREATE TABLE IF NOT EXISTS `Meter` " + "(`id` INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,"
