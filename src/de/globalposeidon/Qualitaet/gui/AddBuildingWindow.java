...
public class AddBuildingWindow extends JDialog {
   ...
   public AddBuildingWindow(final DataContainer model) {
      ...
      final JLabel lblBuildingName = new JLabel("Building Name");
      ...
      tfPnl.add(lblBuildingName);
      tfPnl.add(tfBuildingName);
      tfPnl.add(new JLabel("Renter:"));
      tfPnl.add(new JLabel("")); // empty row
   ...
   private void addBuilding(final DataContainer container) {
      ...
      if (tfBuildingName.getText().equals("")) {
         ...
         final Renter tmpRenter = new Renter(tfFirstname.getText(), tfSurname.getText(), tfTel.getText(), tfEmail.getText());
         final Building tmpBuilding = new Building(container, tfBuildingName.getText());
